    ...
    return (
        ...
        <div className='p-5'>
            ...
            <div className='flex items-center  mb-4'>
                ...
                }} to={"/inventory/"+_id} className='btn-myProduct btn-myUpdate flex items-center cursor-pointer'>Update <AiOutlineDoubleRight className='text-lg ml-5 ' /> </button>

                <button onClick={()=> handleDelete(_id)} className='btn-MyDelete btn-myProduct '>DELETE</button>
            </div>
        </div>
    </div>
